...
class TorrentTestCase(unittest.TestCase):
    ...
    def setUp(self):  # NOQA
        ...
        self.core = core = Core()
        eventmanager = self.core.eventmanager
    ...
    def test_torrent_file_missing(self):
        # load the torrent with seed_mode true
        # read_piece 0
    ...
    def test_torrent_error_resume_orignal_state(self):
    ...
    def test_torrent_error_resume_data_unaltered(self):
        ...
        def assert_resume_data():
            self.assert_state(torrent, "Error")
            tm_resume_data = lt.bdecode(self.torrentmanager.resume_data[torrent.torrent_id])
